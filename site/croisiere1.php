<html>
    <head>
        <title>Croisière Barcelone</title>
        <link rel="stylesheet" type="text/css" href="style2.css">
    </head>
    <body>
        <!--Pages d'offres (Steven)-->
        <div class="container">
            <img src="port barcelone.jpg" alt="Arrière plan">
            <h1>Barcelone</h1>
            <h2><p>7 jours, a Barcelone</p></h2>
        </div>
        <div class="carre-blanc">
            <form>
                ...
                <br>
                <br>
                <input type="submit" value="Reserver"><a href="paiement.html">
            </form>
        </div>